...
export function ManifestoSection() {
  ...
  const photos = [
    { url: cityImage, caption: "Urban Atmosphere", color: "#64FFDA" },
    { url: streetImage, caption: "Street Moments", color: "#4A9EFF" },
    { url: glassImage, caption: "Light & Structure", color: "#A78BFA" },
    { url: beachImage, caption: "Perspective", color: "#FFD93D" },
    { url: nightVillageImage, caption: "Nightscape", color: "#FF6B6B" },
  ];
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-7 flex flex-col justify-center pt-10">
            <div className="relative origin-top-left">
              <h1 className="font-black tracking-tighter leading-none text-[#E6F1FF] mb-2 flex flex-wrap items-baseline gap-x-4">
                <span
                  className={`transition-all duration-700 ease-in-out ${
                    isExpanded
                      ? "text-4xl md:text-5xl lg:text-6xl"
                      : "text-7xl md:text-8xl lg:text-9xl delay-300"
                  }`}
                >
                  BE {isExpanded ? "A" : "AN"}
                </span>
                ...
                <AnimatePresence mode="wait">
                  {isExpanded ? (
                    ...
                    <motion.span
                      ...
                      style={{
                        backgroundImage:
                          "linear-gradient(to right, #64FFDA, #4A9EFF, #A78BFA, #FF6B6B, #FFD93D, #64FFDA)",
