...
export function Services() {
  ...
  }, [text, isDeleting, loopNum, isHovered]);
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div
                ...
                className="bg-black border border-[#233554] rounded px-4 py-2 flex items-center gap-3 shadow-[0_0_15px_rgba(0,0,0,0.5)] min-w-[240px] cursor-pointer hover:border-[#64FFDA] transition-colors"
              >
                <Terminal
                ...
                <span className="font-mono text-sm text-[#64FFDA] min-h-[20px]">
                  ...
                  <span className="animate-pulse inline-block w-2 h-4 bg-[#64FFDA] ml-1 align-middle" />
                </span>
              </div>
            </div>
                ...
                {pipeline.map((step, index) => (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <div className="w-8 h-8 rounded-full bg-[#112240] border border-[#233554] flex items-center justify-center text-[10px] font-mono text-[#8892B0] z-10">
                        {step.id}
                      </div>
                    ...
                    <div className="flex-1 bg-[#112240]/30 border border-[#233554] p-6 rounded-xl">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <h3 className="text-[#E6F1FF] font-semibold text-lg">
                            {step.title}
                          </h3>
                        </div>
