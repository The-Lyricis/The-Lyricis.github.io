...
export function ExperienceTimeline() {
  ...
  const timelineData: TimelineItem[] = [
    {
      ...
      type: "future",
      description: messages.experience.descriptions["future-3"],
    ...
    },
    {
      ...
      type: "future",
      description: messages.experience.descriptions["future-2"],
    ...
    },
    {
      ...
      type: "future",
      description: messages.experience.descriptions["future-1"],
    ...
    },
    {
      ...
      type: "education",
      description: messages.experience.descriptions.chalmers,
      technologies: [
        "Interaction Design",
        "Real-time Rendering",
        "Procedural Systems",
    ...
    },
    {
      ...
      type: "work",
      description: messages.experience.descriptions["funplus-ft"],
    ...
    },
    {
      ...
      type: "work",
      description: messages.experience.descriptions["funplus-intern"],
    ...
    },
    {
      ...
      type: "work",
      description: messages.experience.descriptions.seasun,
    ...
    },
    {
      ...
      type: "education",
      description: messages.experience.descriptions.jilin,
  ...
  const itemPositions = useMemo(() => {
    ...
    timelineData.forEach((_, i) => {
      const height = i === activeIndex ? HEIGHT_ACTIVE : HEIGHT_COMPACT;
  ...
  useEffect(() => {
    const handleDragMove = (e: MouseEvent | TouchEvent) => {
      ...
      const stepsMoved = Math.round(deltaY / 24);
      const newIndex = Math.min(
        Math.max(startIndex.current + stepsMoved, 0),
            ...
            <div className="relative pointer-events-none transition-transform duration-200 group-active:scale-95">
              ...
              <div
                className={`
                  ...
                  border group-hover:border-[#64FFDA] group-hover:shadow-[0_0_15px_rgba(100,255,218,0.3)]
              ...
              <div
                className={`
                  ...
                  transition-all duration-200 border-[#64FFDA]
        ...
        <div className="absolute top-0 bottom-0 left-[33%] right-0 pl-0 overflow-hidden pointer-events-none">
          <LayoutGroup>
            <motion.div
              ...
              initial={false}
              animate={{ y: -itemPositions[activeIndex] }}
              ...
              {timelineData.map((item, index) => {
                ...
                return (
                  <motion.div
                    ...
                    style={{ pointerEvents, transform: "translateY(-50%)" }}
                    animate={{ top: topPos, opacity, y: "-50%" }}
                    transition={{ type: "spring", stiffness: 200, damping: 25 }}
                  >
                    <motion.div
                    ...
                    <div className="relative pl-2">
                      {isExpanded ? (
                        <motion.div
                          ...
                          className={`bg-[#0A192F] border rounded-xl p-6 shadow-2xl max-w-xl relative z-50 cursor-default ${isFuture ? "grayscale" : ""}`}
                          style={{
                        ...
                        >
                          ...
                          <div className="flex justify-between items-start mb-2">
                            <motion.span
                              ...
                              className="text-sm font-mono text-[#8892B0] font-bold tracking-wider"
                            >
                              {item.year}
                            </motion.span>
                          </div>
                          ...
                          <motion.h3
                            ...
                            className="text-2xl font-bold text-[#E6F1FF] mb-1"
                          >
                            {item.title}
                          </motion.h3>
                          <motion.h4
                          ...
                          >
                            ...
                            <div className="flex flex-wrap gap-2">
                              {item.technologies?.map((tech) => (
                                <span
                                  key={tech}
                                  className={`px-2 py-1 text-xs rounded border ${isFuture ? "bg-gray-800 text-gray-400 border-gray-700" : "bg-[#112240] text-[#64FFDA] border-[#233554]"}`}
                                >
                                  {tech}
                                </span>
                              ))}
                        ...
                        <motion.div
                          ...
                          className={`bg-[#112240] rounded-lg p-4 shadow-[0_0_20px_rgba(100,255,218,0.1)] cursor-pointer group w-[400px] border transition-all relative overflow-hidden z-40 ${isFuture ? "grayscale brightness-75 hover:grayscale-0" : "hover:border-[#64FFDA]"}`}
                          style={{
                            borderLeft: `4px solid ${item.color}`,
                            borderColor: "#233554",
                          }}
                        >
                          ...
                          <div className="flex justify-between items-start mb-1 pl-3">
                            <motion.span
                              layoutId={`year-${item.id}`}
                              className="text-sm font-mono font-bold text-[#64FFDA] tracking-wider"
                            >
                              {item.year}
                            </motion.span>
                          </div>
                          <div className="pl-3">
                            <motion.h3
                              layoutId={`title-${item.id}`}
                              className={`text-lg font-bold text-[#E6F1FF] transition-colors ${!isFuture ? "group-hover:text-[#64FFDA]" : ""}`}
                            >
                              {item.title}
                            </motion.h3>
                            <motion.h4
                        ...
                        <motion.div
                          ...
                          className={`flex items-center gap-3 px-3 py-1.5 rounded-full cursor-pointer border border-[#233554] hover:bg-[#112240] transition-all bg-[#0a192f]/80 backdrop-blur-sm ${isFuture ? "grayscale hover:grayscale-0" : "hover:border-[#64FFDA]"}`}
                        >
